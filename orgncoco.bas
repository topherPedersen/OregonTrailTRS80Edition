...
680 PRINT "GOOD LUCK!!!"
681 PRINT
682 PRINT "PRESS <ENTER> TO CONTINUE";
683 INPUT CT$
690 PRINT
...
716 PRINT " (4) NEED MORE PRACTICE"
...
830 PRINT
840 PRINT
849 REM P "1234567890123456789012345678901"
...
1149 REM P "1234567890123456789012345678901"
...
1680 GOTO 1720
1689 REM P "1234567890123456789012345678901"
...
1839 REM P "1234567890123456789012345678901"
...
2070 X1=X1*(-1)
2079 REM P "1234567890123456789012345678901"
...
2239 REM P "1234567890123456789012345678901"
...
2549 REM P "1234567890123456789012345678901"
...
2660 PRINT "RIGHT BETWEEN THE EYES---YOU GOT"
2670 PRINT "A BIG ONE! FULL BELLIES TONIGHT!"
2680 F=F+52+RND(0)*6
2690 B=B-10-RND(0)*4
2700 GOTO 2720
2710 PRINT "YOU MISSED---AND YOUR DINNER GOT": PRINT "AWAY....."
...
2960 PRINT "TACTICS:"
2969 REM P "1234567890123456789012345678901"
2970 PRINT 
2971 PRINT "  (1) RUN"
2972 PRINT "  (2) ATTACK"
...
3149 REM P "1234567890123456789012345678901"
3150 PRINT "NICE SHOOTING--- YOU DROVE THEM": PRINT "OFF"
3160 GOTO 3470
3170 IF B1 <= 4 THEN 3220
3180 PRINT "LOUSY SHOT---YOU GOT KNIFED"
3190 K8=1
3200 PRINT "YOU HAVE TO SEE OL' DOC": PRINT "BLANCHARD"
3210 GOTO 3470
...
3479 REM P "1234567890123456789012345678901"
3480 PRINT "RIDERS WERE FRIENDLY, BUT CHECK": PRINT "FOR POSSIBLE LOSSES"
3490 GOTO 3550
3500 PRINT "RIDERS WERE HOSTILE--CHECK FOR": PRINT "LOSES"
3510 IF B >= 0 THEN 3550
3520 PRINT "YOU RAN OUT OF BULLETS AND GOT": PRINT "MASSACRED BY THE RIDERS"
3530 GOTO 5170
...
3659 REM P "1234567890123456789012345678901"
3660 PRINT "WAGON BREAKS DOWN--LOSE TIME": PRINT "AND SUPPLIES FIXING IT"
3670 M=M-15-5*RND(0)
3680 M1=M1-8
3690 GOTO 4710
3700 PRINT "0X INJURES LEG---SLOWS YOU DOWN": PRINT "REST OF TRIP"
3710 M=M-25
3720 A=A-20
3730 GOTO 4710
3739 REM P "1234567890123456789012345678901"
3740 PRINT "BACK LUCK---YOUR DAUGHTER BROKE"
3741 PRINT "HER ARM. YOU HAD TO STOP AND"
3742 PRINT "USE SUPPLIES TO MAKE A SLING."
3760 M=M-5-4*RND(0)
3770 M1=M1-2-3*RND(0)
3780 GOTO 4710
3790 PRINT "OX WANDERS OFF---SPEND TIME": PRINT "LOOKING FOR IT"
3800 M=M-17
3810 GOTO 4710
3820 PRINT "YOUR SON GETS LOST---SPEND": PRINT "HALF THE DAY LOOKING FOR HIM"
3830 M=M-10
3840 GOTO 4710
3849 REM P "1234567890123456789012345678901"
3850 PRINT "UNSAFE WATER--LOSE TIME LOOKING": PRINT "FOR CLEAN SPRING"
3860 M=M-10*RND(0)-2
3870 GOTO 4710
3880 IF M>950 THEN 4490
3890 PRINT "HEAVY RAINS---TIME AND SUPPLIES": PRINT "LOST"
3910 F=F-10
3920 B=B-500
3930 M1=M1-15
3940 M=M-10*RND(0)-5
...
3999 REM P "1234567890123456789012345678901"
4000 PRINT "YOU RAN OUT OF BULLETS---THEY": PRINT "GET LOTS OF CASH"
4010 T=T/3
4020 GOTO 4040
4030 IF B1 <= 1 THEN 4100
4040 PRINT "YOU GOT SHOT IN THE LEG AND": PRINT "THEY TOOK ONE OF YOUR OXEN"
4050 K8=1
4060 PRINT "BETTER HAVE A DOC LOOK AT YOUR": PRINT "WOUND"
4070 M1=M1-5
4080 A=A-20
4090 GOTO 4710
4100 PRINT "QUICKEST DRAW OUTSIDE OF DODGE": PRINT "CITY!!!"
4110 PRINT "YOU GOT 'EM!"
4120 GOTO 4710
4129 REM P "1234567890123456789012345678901"
4130 PRINT "THERE WAS A FIRE IN YOUR WAGON,": PRINT "FOOD AND SUPPLIES DAMAGE!"
4140 F=F-40
4150 B=B-400
4160 M1=M1-RND(0)*8-3
4170 M=M-15
4180 GOTO 4710
4190 PRINT "LOSE YOUR WAY IN HEAVY FOG,": PRINT "TIME IS LOST"
4200 M=M-10-5*RND(0)
4210 GOTO 4710
4220 PRINT "YOU KILLED A POISONOUS SNAKE": PRINT "AFTER IT BIT YOU"
4230 B=B-10
4240 M1=M1-5
4250 IF M1 >= 0 THEN 4280
4259 REM P "1234567890123456789012345678901"
4260 PRINT "YOU DIE OF SNAKEBITE SINCE YOU": PRINT "HAVE NO MEDICINE"
4270 GOTO 5170
4280 GOTO 4710
4290 PRINT "WAGON GETS SWAMPED FORDING": PRINT "RIVER--LOSE FOOD AND CLOTHES"
4300 F=F-30
4310 C=C-20
...
4419 REM P "1234567890123456789012345678901"
4420 PRINT "NICE SHOOTIN' PARTNER---THEY": PRINT "DIDN'T GET MUCH"
4430 GOTO 4450
4440 PRINT "SLOW ON THE DRAW---THEY GOT AT": PRINT "YOUR FOOD AND CLOTHES"
4450 B=B-20*B1
4460 C=C-B1*4
4470 F=F-B1*8
4480 GOTO 4710
...
4660 GOTO 4710
4669 REM P "1234567890123456789012345678901"
4670 PRINT "HELPFUL INDIANS SHOW YOU WHERE": PRINT "TO FIND MORE FOOD"
4680 F=F+14
4690 GOTO 4710
4700 REM ***MOUNTAINS***
...
4749 REM P "1234567890123456789012345678901"
4750 PRINT "YOU GOT LOST---LOSE VALUABLE": PRINT "TIME TRYING TO FIND TRAIL!"
4760 M=M-60
4770 GOTO 4860
4780 IF RND(0)>.11 THEN 4840
4790 PRINT "WAGON DAMAGED!---LOSE TIME AND": PRINT "SUPPLIES": PRINT
4800 M1=M1-5
4810 B=B-200
...
4889 REM P "1234567890123456789012345678901"
4890 PRINT "YOU MADE IT SAFELY THROUGH": PRINT "SOUTH PASS--NO SNOW": PRINT
...
4950 M9=1
4960 GOTO 1230
4969 REM P "1234567890123456789012345678901"
4970 PRINT "BLIZZARD IN MOUNTAIN PASS--TIME": PRINT "AND SUPPLIES LOST": PRINT
4980 L1=1
4990 F=F-25
5000 M1=M1-10
5010 B=B-300
...
5040 GOTO 4940
5050 REM ***DYING***
5059 REM P "1234567890123456789012345678901"
5060 PRINT "YOU RAN OUT OF FOOD AND STARVED": PRINT "TO DEATH": PRINT
5070 GOTO 5170
5080 T=0
...
5160 PRINT "INJURIES"
5170 PRINT
5179 REM P "1234567890123456789012345678901"
5180 PRINT "DUE TO YOUR UNFORTUNATE"
5181 PRINT "SITUATION, THERE ARE A FEW"
5182 PRINT "FORMALITIES WE MUST GO THROUGH"
5200 PRINT
5210 PRINT "WOULD YOU LIKE A MINISTER?"
5220 INPUT C$
5230 PRINT "WOULD YOU LIKE A FANCY FUNERAL?"
5240 INPUT C$
5250 PRINT "WOULD YOU LIKE US TO INFORM": PRINT "YOUR NEXT OF KIN?": PRINT
5260 INPUT C$
5270 IF C$="YES" THEN 5310
5279 REM P "1234567890123456789012345678901"
...
5320 PRINT
5329 REM P "1234567890123456789012345678901"
...
5390 PRINT
5399 REM P "1234567890123456789012345678901"
5400 PRINT "OREGON CITY CHAMBER OF COMMERCE"
...
5469 REM P "1234567890123456789012345678901"
...
6045 PRINT "CASH: ";T
6050 PRINT
6059 REM P "1234567890123456789012345678901"
...
6210 B3 = 30000
6220 INPUT C$
6221 REM MODIFIED HUNTING ROUTINE BY CDP FOR COMPATIBILITY WITH
6222 REM SHACK COLOR BASIC FOR THE TRS-80 COLOR COMPUTER. UNFORTUNATELY
6223 REM COLOR BASIC DIDN'T HAVE ANY SORT OF TIMER FUNCTION, SO WE CAN'T
6224 REM TIME THE USER TO DETERMINE HUNTING SUCCESS. INSTEAD WE USE SIMPLE
6225 REM RANDOM NUMBER GENERATION TO DETERMINE OUTCOMES.
6226 B4=RND(0)*100+1: B5=RND(0)*100+1
6227 IF B4>33 THEN B1=B3+0
6228 IF B4>33 THEN 6240
6229 IF B4>40 THEN B1=B3+0
6230 IF B4>40 THEN 6240
6231 IF B4>50 THEN B1=B3+0
6232 IF B4>50 THEN 6240
6233 IF B4>60 THEN B1=B3+0
6234 IF B4>60 THEN 6240
6235 IF B4>66 THEN B1=B3+0
6236 IF B4>66 THEN 6240
6237 IF B5>=50 THEN B1=B3+12
6238 IF B5<50 THEN B1=B3+15
...
6319 REM P "1234567890123456789012345678901"
