...
6226 B4=RND(0)*100+1
6227 IF B4<51 THEN B1=B3+0
6228 IF B4<51 THEN 6240
6229 B1=B3+15
...
6270 B1=9
6271 RETURN
6272 REM *** EASY SHOOTING SUB-ROUTINE ***
6273 S6=INT(RND(0)*4+1)
6274 PRINT "TYPE "; S$(S6)
6275 B3 = 30000
6276 INPUT C$
6277 B4=RND(0)*100+1
6278 IF B4<96 THEN B1=B3+0
6279 IF B4<96 THEN 6281
6280 B1=B3+15
6281 B1=((B1-B3)*3600)-(D9-1)
6282 PRINT
