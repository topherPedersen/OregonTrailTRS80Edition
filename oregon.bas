...
210 PRINT
240 PRINT "THIS PROGRAM SIMULATES A 2,040"
...
910 PRINT "TOO MUCH"
920 GOTO 850
930 PRINT Z9$: PRINT "ON FOOD"
940 INPUT F
950 IF F >= 0 THEN 980
960 PRINT "IMPOSSIBLE"
970 GOTO 930
980 PRINT Z9$: PRINT "ON AMMUNITION"
990 INPUT B
1000 IF B >= 0 THEN 1030
1010 PRINT "IMPOSSIBLE"
1020 GOTO 980
1030 PRINT Z9$: PRINT "ON CLOTHING"
1040 INPUT C
1050 IF C >= 0 THEN 1080
1060 PRINT "IMPOSSIBLE"
1070 GOTO 1030
1080 PRINT Z9$: PRINT "ON MISCELLANEOUS SUPPLIES"
1090 INPUT M1
...
1305 YR$="1847"
1310 PRINT "APR 12 "YR$: GOTO 1720
1330 PRINT "APR 26 "YR$: GOTO 1720
1350 PRINT "MAY 10 "YR$: GOTO 1720
1370 PRINT "MAY 24 "YR$: GOTO 1720
1390 PRINT "JUN 7 "YR$: GOTO 1720
1410 PRINT "JUN 21 "YR$: GOTO 1720
1430 PRINT "JUL 5 "YR$: GOTO 1720
1450 PRINT "JUL 19 "YR$: GOTO 1720
1470 PRINT "AUG 2 "YR$: GOTO 1720
1490 PRINT "AUG 16 "YR$: GOTO 1720
1510 PRINT "AUG 31 "YR$: GOTO 1720
1530 PRINT "SEP 13 "YR$: GOTO 1720
1550 PRINT "SEP 27 "YR$: GOTO 1720
1570 PRINT "OCT 11 "YR$: GOTO 1720
1590 PRINT "OCT 25 "YR$: GOTO 1720
1610 PRINT "NOV 8 "YR$: GOTO 1720
1630 PRINT "NOV 22 "YR$: GOTO 1720
1650 PRINT "DEC 6 "YR$: GOTO 1720
1670 PRINT "DEC 20 "YR$: GOTO 1720
...
5333 PRINT "TERRITORY OF OREGON. BETTER"
5350 PRINT "LUCK NEXT TIME."
5360 PRINT
...
5750 D3=D3-124
5760 PRINT "AUG ";D3;" 1847"
5770 GOTO 5920
5780 IF D3>185 THEN 5820
5790 D3=D3-155
5800 PRINT "SEP ";D3;" 1847"
5810 GOTO 5920
5820 IF D3>216 THEN 5860
5830 D3=D3-185
5840 PRINT "OCT ";D3;" 1847"
5850 GOTO 5920
5860 IF D3>246 THEN 5900
5870 D3=D3-216
5880 PRINT "NOV ";D3;" 1847"
5890 GOTO 5920
5900 D3=D3-246
5910 PRINT "DEC ";D3;" 1847"
5920 PRINT
...
6030 F=0
6040 PRINT "FOOD: ";INT(F)
6042 PRINT "BULLETS: ";INT(B)
6043 PRINT "CLOTHING: ";INT(C)
6044 PRINT "MISC. SUPP.: ";INT(M1)
6045 PRINT "CASH: ";INT(T)
6050 PRINT
